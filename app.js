var letters = [
  ...
  function draw(){
    ...
    f -= floor(f);
    f = 4*pow(f - .5, 3); //offset the timing of the letters to this curve: https://www.desmos.com/calculator/yivpzh6ru2
    ...
    for (var i = 0; i < swirlers.length; i++){
      var swirl = swirlers[i];
      swirl.tick();
      swirl.render();
      if (swirl.size > 10){
        swirlers.splice(i, 1);
